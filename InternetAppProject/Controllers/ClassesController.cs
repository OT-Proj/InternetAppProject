...
namespace InternetAppProject.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(InternetAppProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id")] Class @class)
        {
            if (id != @class.id)
            {
                return NotFound();
